...
from modeling import BertForSequenceEmbedding
...
MODEL_CLASSES = {
    'bert': (BertConfig, BertForSequenceEmbedding, BertTokenizer),
}
...
def load_and_cache_examples(args, task, tokenizer, split=None, evaluate=False):
    ...
    all_attention_masks = torch.tensor(
            select_field(features, 'attention_mask', evaluate), dtype=torch.long)

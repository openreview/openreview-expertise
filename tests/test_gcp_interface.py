...
@patch("expertise.service.utils.aip.PipelineJob")  # Mock PipelineJob
@patch("expertise.service.utils.storage.Client")  # Mock GCS Client
def test_create_job_with_mongo_params(mock_storage_client, mock_pipeline_job, mock_time, openreview_client):
    ...
    # Initialize via config to include secret + db params
    config = {
        ...
        # New config keys
        'MONGODB_URI_SECRET_ID': 'mongodb-uri',
    ...
    # New fields
    assert params["mongodb_uri_secret_id"] == 'mongodb-uri'

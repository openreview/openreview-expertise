...
def test_archives_dataset():
    ...
    archives_dataset.add_publication(
        '{"id":"N6F1Vu82","content":{"title":"Insert esoph obtu airway","abstract":"Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum."} }',
        "~Loreta_Tremblay3",
    )
    assert len(archives_dataset["~Loreta_Tremblay3"]) == 4

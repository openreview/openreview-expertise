...
def test_get_profile_ids():
    ...
    ids, _ = or_expertise.get_profile_ids(
        reviewer_ids=[
            "hkinder2b@army.mil",
            "cchippendale26@smugmug.com",
            "mdagg5@1und1.de",
        ]
    )
    assert len(ids) == 3
    assert sorted(ids) == sorted(
        [
            ("~Romeo_Mraz2", "hkinder2b@army.mil"),
            ("~Stacee_Powlowski9", "mdagg5@1und1.de"),
            ("~Stanley_Bogisich4", "cchippendale26@smugmug.com"),
        ]
    )
    ...
    ids, inv_ids = or_expertise.get_profile_ids(
        reviewer_ids=[
            "hkinder2b@army.mil",
            "cchippendale26@smugmug.com",
            "mdagg5@1und1.de",

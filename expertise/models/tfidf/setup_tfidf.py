...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-c",
        "--config_path",
        default="./config-tfidf.json",
        help="a config file for a model",
    )
    ...
    (train_set_ids, dev_set_ids, test_set_ids) = expertise.utils.split_ids(
    ...
    expertise.utils.dump_jsonl(
        os.path.join(setup_dir, "test_labels.jsonl"), test_labels
    )

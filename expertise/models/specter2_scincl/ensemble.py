...
class EnsembleModel:
    ...
    def embed_publications(self, specter_publications_path=None, scincl_publications_path=None,
                           cached_specter_publications=None, cached_scincl_publications=None, skip_specter=False):
        result = {}
        if not skip_specter:
            print("SPECTER:")
        ...
        print("SciNCL:")
        result['scincl'] = self.scincl_predictor.embed_publications(
            scincl_publications_path, cached_publications=cached_scincl_publications
        )
        return result

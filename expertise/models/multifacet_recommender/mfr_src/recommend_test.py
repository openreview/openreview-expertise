...
parser = argparse.ArgumentParser(
    description="PyTorch Neural Set Decoder for Sentnece Embedding"
)
...
parser.add_argument(
    "--data",
    type=str,
    default="./data/processed/citeulike-a_lower/",
    help="location of the data corpus",
)
parser.add_argument(
    "--tensor_folder",
    type=str,
    default="tensors_cold_0",
    help="location of the data corpus",
)
parser.add_argument(
    "--checkpoint", type=str, default="./models/", help="model checkpoint to use"
)
parser.add_argument(
    "--tag_emb_file",
    type=str,
...
parser.add_argument("--cuda", type=str2bool, nargs="?", default=True, help="use CUDA")
parser.add_argument(
    "--single_gpu", default=False, action="store_true", help="use single GPU"
)
...
with open(args.outf, "w") as outf:
    recommend_test(
        ...
        outf,
        device,
        args.most_popular_baseline,
        args.div_eval,
        args.switch_user_tag_roles,
        args.store_dist,

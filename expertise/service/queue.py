import threading, queue, os, shutil, logging
from typing import *
...
class JobQueue:
    ...
    Status semantics:
        ...
        "processing" -- The job is currently being worked on by a worder
        ...
        "timeout" -- The job has exceeded the specified timeout
    ...
    def __init__(self, max_jobs: int = 1) -> None:
        ...
        # TODO: Decide eviction policy from submitted datastore
